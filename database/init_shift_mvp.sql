...
(1, 'E001', '张店长', '12312341234', '管理', '2024-01-01', '管理岗', 48, 1),
(1, 'E002', '李文员', '12312341234', '行政', '2024-01-02', '文员仓管', 48, 1),
(1, 'E003', '王仓管', '12312341234', '行政', '2024-01-03', '文员仓管', 48, 1),
(1, 'E004', '赵工程', '12312341234', '工程', '2024-01-04', '工程维修岗', 48, 1),
(1, 'E005', '钱网络', '12312341234', '工程', '2024-01-05', '网络维护', 48, 1),
(1, 'E006', '孙采购', '12312341234', '行政', '2024-01-06', '采购岗', 48, 1),
(1, 'E007', '周保洁', '12312341234', '保洁', '2024-01-07', '保洁岗', 48, 1),
(1, 'E008', '吴咨客', '12312341234', '楼面', '2024-01-08', '咨客岗', 48, 1),
(1, 'E009', '郑咨客', '12312341234', '楼面', '2024-01-09', '咨客岗', 48, 1),
(1, 'E010', '冯厨房', '12312341234', '厨房', '2024-01-10', '厨房岗', 48, 1),
(1, 'E011', '陈厨房', '12312341234', '厨房', '2024-01-11', '厨房岗', 48, 1),
(1, 'E012', '褚厨房', '12312341234', '厨房', '2024-01-12', '厨房岗', 48, 1),
(1, 'E013', '卫传送', '12312341234', '楼面', '2024-01-13', '传送岗', 48, 1),
(1, 'E014', '蒋传送', '12312341234', '楼面', '2024-01-14', '传送岗', 48, 1),
(1, 'E015', '沈服务', '12312341234', '楼面', '2024-01-15', '服务岗', 48, 1),
(1, 'E016', '韩服务', '12312341234', '楼面', '2024-01-16', '服务岗', 48, 1),
(1, 'E017', '杨服务', '12312341234', '楼面', '2024-01-17', '服务岗', 48, 1),
(1, 'E018', '朱客户', '12312341234', '楼面', '2024-01-18', '客户经理岗', 48, 1),
(1, 'E019', '秦客户', '12312341234', '楼面', '2024-01-19', '客户经理岗', 48, 1),
(1, 'E020', '尤内吧', '12312341234', '吧台', '2024-01-20', '内吧岗', 48, 1),
(1, 'E021', '许外吧', '12312341234', '吧台', '2024-01-21', '外吧岗', 48, 1),
(1, 'E022', '何吧台', '12312341234', '吧台', '2024-01-22', '内吧岗', 48, 1),
(1, 'E023', '赵保洁', '12312341234', '保洁', '2024-01-23', '保洁岗', 48, 1);
